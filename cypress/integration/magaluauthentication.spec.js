...
// });
    it('Usuarios deve poder realizar um login no sistema', () => {
        ...
        cy.get('#email').type('qacompasso@compasso.com.br').should('have.value', 'qacompasso@compasso.com.br');
        cy.get('#passwd').type('123456789').should('have.value', '123456789'); //.should asserção para confirmação da escrita
